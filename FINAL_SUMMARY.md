...
**Problem:** Always showed "10-30 seconds" but actually took 30-90+ seconds, varying by page count

**Fix:**
- Calculate realistic estimates based on page count
- Formula: 60s base + 5s per page
- Examples: 10 pages = "90-120 seconds", 50 pages = "4-5 minutes", 111 pages = "9-10 minutes"
- Much more accurate expectations

**Files:** `app/dashboard/jobs/[jobId]/plans/[planId]/page.tsx`

### 3. ✅ Quality Analysis Missing
