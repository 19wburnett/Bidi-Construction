...
export async function generateAnswer(
  ...
  // Note: Vectorization status is checked in the route handler before this function is called.
  // If we reach here, the plan should already be vectorized. If chunks are empty, it just means
  // the semantic search didn't find relevant chunks for this query, which is normal.
